...
def generar_pdf_detalle(request, trabajador_id):
    ...
    # Estilo para el nombre de competencia dentro de la celda
    ...
    # Estilo para el texto del indicador (línea pequeña debajo)
    ...
    # Estilo para indicador en tabla funcional
    ...
    jefe_directo_nombre = (
        f"{trabajador.id_jefe_directo.nombre} {trabajador.id_jefe_directo.apellido_paterno} {trabajador.id_jefe_directo.apellido_materno}"
    ...
    for r in resultados_organizacionales:
        # ✅ Celda con competencia en bold + indicador en gris pequeño debajo
        celda = [
    ...
    # ✅ La columna de Competencia/Indicador es más ancha para acomodar el texto
    ...
    org_table.setStyle(TableStyle([
        ...
        ('ALIGN',         (1, 0), (1, -1),  'LEFT'),   # columna competencia alineada izquierda
        ('VALIGN',        (0, 0), (-1, -1), 'MIDDLE'),
        ('VALIGN',        (1, 1), (1, -1),  'TOP'),    # texto indicador desde arriba
