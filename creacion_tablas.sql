...
SET FOREIGN_KEY_CHECKS = 0; -- Para no tener problemas con lo del user en trabajador
...
-- =========================
-- Tabla Trabajador (Actualizada para Login)
-- =========================
CREATE TABLE TRABAJADOR (
    ...
    USER_ID INT UNIQUE NULL, -- <--- Columna para vincular con Django Auth
...
SET FOREIGN_KEY_CHECKS = 1; -- Para no tener problemas con lo del user en trabajador